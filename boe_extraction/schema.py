...
ICEGATE_FIELDS = [
    ...
    ('PART - II - INVOICE & VALUATION DETAILS (Invoice 1 2 )', '4.LC NO & DATE'),
    ('PART - II - INVOICE & VALUATION DETAILS (Invoice 1 2 )', '5.CONTRACT NO & DATE'),
    ('PART - II - INVOICE & VALUATION DETAILS (Invoice 1 2 )', "1.BUYER'S NAME & ADDRESS"),
    ('PART - II - INVOICE & VALUATION DETAILS (Invoice 1 2 )', "2.SELLER'S NAME & ADDRESS"),
    ('PART - II - INVOICE & VALUATION DETAILS (Invoice 1 2 )', '3.SUPPLIER NAME & ADDRESS'),
    ('PART - II - INVOICE & VALUATION DETAILS (Invoice 1 2 )', '4.THIRD PARTY NAME & ADDRESS'),
